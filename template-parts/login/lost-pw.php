							...
							<div class=" et_pb_login_form">
								<form method="post" id="login_form">
									<div class="et_pb_contact_form_field">
										<label class="et_pb_contact_form_label" for="email">Zadejte e-mail použitý při registraci</label>
										<input type="email" id="email" class="input form-control" name="resetPw_login" placeholder="E-mail" required data-pristine-required-message="Toto pole je povinné">
									</div>
									<button type="submit" name="resetPw_check" class="et_pb_button">Odeslat</button>
								</form>
							</div>
						</div>
					</div><!-- .et_pb_column -->
